exports.init = function(router) {
  ...
  router.get(mockApiRoot + '/posts/:postId', function(req, res) {
    var result = {
      postId: 1,
      postTags: "Clothing, Shoes",
      creationDate: "03-02-2017",
      description: "Suit, tuxedo, black leather shoes.",
      location: null,
      ...
      user: { id: 8, firstName: "Jack", lastName: "Shephard" }
    };
  ...
  router.get(mockApiRoot + '/posts/:post/offers', function(req, res) {
    var result = [
      { id: 1, time: "03-02-2017", seller: { id: 1, firstName: "Hugo", lastName: "Reyes" }, replyCount: 0 },
  ...
  router.get(mockApiRoot + '/offers/:offer/messages', function(req, res) {
    var result = [
      { id: 1, sender: { id: 8, firstName: "Jack", lastName: "Shephard" }, creationDate: "03-02-2017 12:05", description: "I've got some food for you. Fruits, fish, even boar." },
      { id: 2, sender: { id: 1, firstName: "Hugo", lastName: "Reyes" }, creationDate: "03-02-2017 12:37", description: "Awesome, I love fish." },
      { id: 3, sender: { id: 8, firstName: "Jack", lastName: "Shephard" }, creationDate: "03-02-2017 15:09", description: "Sorry, I had to go. So?" },
      { id: 4, sender: { id: 8, firstName: "Jack", lastName: "Shephard" }, creationDate: "03-02-2017 16:37", description: "Are you still interested?" }
    ];
  ...
  router.post(mockApiRoot + '/messages', function(req, res) {
    var result = {};
    result.description = req.body.description;
    result.id = 5;
    result.sender = { id: 1, firstName: "Hugo", lastName: "Reyes" };
