exports.init = function(router) {
  ...
  router.get(mockApiRoot + '/users/:user/notifications', function(req, res) {
    var alerts = [
      { postId: 1, seller: { id: 1, name: "BigBurger" }, creationDate: "15-12-2016", description: "Suit, tuxedo, black leather shoes." },
      { postId: 2, seller: { id: 1, name: "BigBurger" }, creationDate: "29-01-2017", description: "Ralph Lauren Polo, Lacoste or Tommy Hilfiger." },
      { postId: 3, seller: { id: 1, name: "BigBurger" }, creationDate: "03-02-2017", description: "I'm looking for a blue denim shirt, send me a pic if you've got one." },
      { postId: 4, seller: { id: 2, name: "Gelato" }, creationDate: "03-02-2017", description: "I'm looking for a blue denim shirt, send me a pic if you've got one." },
      { postId: 5, seller: { id: 2, name: "Gelato" }, creationDate: "03-02-2017", description: "I'm looking for a blue denim shirt, send me a pic if you've got one." }
    ];
